...
const points = [
  ...
  },
  {
    ...
    text: "When you close a token account, Solana returns the full rent deposit to your wallet. Ars​weep helps you find and close empty accounts to reclaim that SOL.",
  },
];
