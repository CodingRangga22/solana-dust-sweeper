...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 left-0 h-full w-64 z-[100] ml-0 bg-background border-r border-border flex flex-col transition-transform duration-300 ${open ? "translate-x-0" : "-translate-x-full"}`}>
